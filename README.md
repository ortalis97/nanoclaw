...
Only Or (`972548183824`) and Maya (`972543108007`) can interact with Alfred. DMs from other numbers are silently dropped; groups only respond if Or or Maya are members. Configured via `ALLOWED_SENDERS` in `.env`.
